...
public class WorldGenBamboo extends TCGenBase {
	...
	private static final Block BAMBOO_BLOCK = TCBlockRegistry.bambooShoot;
	...
	public boolean generate(int i, int j, int k) {
		...
		for(int l = 0; l < amount; l++) {
			...
			for(int h = 0; h < height; h++) {
				if(worldObj.isAirBlock(x, y + h, z)/* && TropicraftBlocks.bambooShoot.canBlockStay(world, x, y + h, z)*/) { //TODO: Can block stay code
