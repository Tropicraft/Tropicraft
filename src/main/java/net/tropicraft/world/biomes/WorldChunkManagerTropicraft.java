...
public class WorldChunkManagerTropicraft extends WorldChunkManager {
	...
	public static final List<BiomeGenBase> allowedBiomes = Arrays.asList(BiomeGenTropicraft.tropics, BiomeGenTropicraft.rainforestPlains);
    ...
    public WorldChunkManagerTropicraft(long seed, WorldType worldType)
    {
        this();
    ...
    public WorldChunkManagerTropicraft(World world)
    {
