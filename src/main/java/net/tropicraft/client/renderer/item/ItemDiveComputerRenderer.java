    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
      ...
      //      System.out.println("hey");
       /*     TextureCompass texturecompass = (TextureCompass)textureatlassprite1;
        ...
        drawString(currentDepth, 68, 80, 0xddddff);
        GL11.glPushMatrix();
        GL11.glScalef(0.6F, 0.6F, 1.0F);
        drawString(String.format("%.0f %s", timeRemaining, timeUnits), 42, 46, 0xF6EB12);
        GL11.glPopMatrix();
        GL11.glScalef(0.5F, 0.5F, 1.0F);
        drawString("Y", 179, 172, 0xffffff);
        drawString("psi", 242, 59, 0xffffff);
        drawString("Air", 210, 41, 0xffffff);
        drawString(airTemp + " F", 20, 210, 0xffffffff);
        drawString(TropicraftUtils.translateGUI("maxDepth") + ": " + maxDepth, 190, 142, 0xffffffff);
