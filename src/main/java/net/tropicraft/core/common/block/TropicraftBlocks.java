...
public class TropicraftBlocks {
    ...
    public static final RegistryObject<Block> CHUNK = register(
            "chunk", Builder.block(Block.Properties.create(Material.ROCK, MaterialColor.BLACK).hardnessAndResistance(2, 30)));
    
    public static final RegistryObject<Block> AZURITE_ORE = register(
            "azurite_ore", () -> new BlockTropicraftOre(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).sound(SoundType.STONE).hardnessAndResistance(3, 5)));
    public static final RegistryObject<Block> EUDIALYTE_ORE = register(
            "eudialyte_ore", () -> new BlockTropicraftOre(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).sound(SoundType.STONE).hardnessAndResistance(3, 5)));
    public static final RegistryObject<Block> MANGANESE_ORE = register(
            "manganese_ore", () -> new BlockTropicraftOre(Block.Properties.create(Material.ROCK, MaterialColor.BLACK).sound(SoundType.STONE).hardnessAndResistance(3, 5)));
    public static final RegistryObject<Block> SHAKA_ORE = register(
            "shaka_ore", () -> new BlockTropicraftOre(Block.Properties.create(Material.ROCK, MaterialColor.BLACK).sound(SoundType.STONE).hardnessAndResistance(3, 5)));
    public static final RegistryObject<Block> ZIRCON_ORE = register(
            "zircon_ore", () -> new BlockTropicraftOre(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).sound(SoundType.STONE).hardnessAndResistance(3, 5)));

    public static final RegistryObject<Block> AZURITE_BLOCK = register(
            "azurite_block", () -> new BlockTropicraftOreBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).sound(SoundType.STONE).hardnessAndResistance(3, 5)));
    public static final RegistryObject<Block> EUDIALYTE_BLOCK = register(
            "eudialyte_block", () -> new BlockTropicraftOreBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).sound(SoundType.STONE).hardnessAndResistance(3, 5)));
    public static final RegistryObject<Block> ZIRCON_BLOCK = register(
            "zircon_block", () -> new BlockTropicraftOreBlock(Block.Properties.create(Material.ROCK, MaterialColor.GRAY).sound(SoundType.STONE).hardnessAndResistance(3, 5)));
    ...
    public static final RegistryObject<Block> BAMBOO_BUNDLE = register(
            "bamboo_bundle", Builder.bundle(Block.Properties.create(Material.WOOD).sound(SoundType.BAMBOO)));
    public static final RegistryObject<Block> THATCH_BUNDLE = register(
            "thatch_bundle", Builder.bundle(Block.Properties.create(Material.WOOD).sound(SoundType.PLANT)));
    ...
    public static final RegistryObject<Block> PALM_STAIRS = register(
            "palm_stairs", Builder.stairs(PALM_PLANKS, Material.WOOD, MaterialColor.BROWN, BlockRenderLayer.SOLID, SoundType.WOOD));
    public static final RegistryObject<Block> MAHOGANY_STAIRS = register(
            "mahogany_stairs", Builder.stairs(MAHOGANY_PLANKS, Material.WOOD, MaterialColor.BROWN, BlockRenderLayer.SOLID, SoundType.WOOD));
    public static final RegistryObject<Block> THATCH_STAIRS = register(
            "thatch_stairs", Builder.stairs(THATCH_BUNDLE, Material.WOOD, MaterialColor.YELLOW, BlockRenderLayer.SOLID, SoundType.PLANT));
    public static final RegistryObject<Block> THATCH_STAIRS_FUZZY = register(
            "thatch_stairs_fuzzy", Builder.stairs(THATCH_BUNDLE, Material.WOOD, MaterialColor.YELLOW, BlockRenderLayer.CUTOUT_MIPPED, SoundType.PLANT));
    public static final RegistryObject<Block> BAMBOO_STAIRS = register(
            "bamboo_stairs", Builder.stairs(BAMBOO_BUNDLE, Material.BAMBOO, MaterialColor.YELLOW, BlockRenderLayer.SOLID, SoundType.BAMBOO));
    public static final RegistryObject<Block> CHUNK_STAIRS = register(
            "chunk_stairs", Builder.stairs(CHUNK, Material.ROCK, MaterialColor.BLACK, BlockRenderLayer.SOLID, SoundType.STONE));
    ...
    public static final RegistryObject<Block> BAMBOO_SLAB = register(
            "bamboo_slab", Builder.slab(Block.Properties.create(Material.BAMBOO, MaterialColor.GREEN).sound(SoundType.BAMBOO).hardnessAndResistance(BlockHardnessValues.BAMBOO.hardness, BlockHardnessValues.BAMBOO.resistance)));
    public static final RegistryObject<Block> THATCH_SLAB = register(
            "thatch_slab", Builder.slab(Block.Properties.create(Material.WOOD, MaterialColor.YELLOW).sound(SoundType.PLANT).hardnessAndResistance(BlockHardnessValues.THATCH.hardness, BlockHardnessValues.THATCH.resistance)));
    public static final RegistryObject<Block> CHUNK_SLAB = register(
            "chunk_slab", Builder.slab(Block.Properties.create(Material.ROCK, MaterialColor.BLACK).sound(SoundType.STONE).hardnessAndResistance(BlockHardnessValues.CHUNK.hardness, BlockHardnessValues.CHUNK.resistance)));
    public static final RegistryObject<Block> PALM_SLAB = register(
            "palm_slab", Builder.slab(Block.Properties.create(Material.WOOD, MaterialColor.BROWN).sound(SoundType.WOOD).hardnessAndResistance(BlockHardnessValues.PALM.hardness, BlockHardnessValues.PALM.resistance)));
    public static final RegistryObject<Block> MAHOGANY_SLAB = register(
            "mahogany_slab", Builder.slab(Block.Properties.create(Material.WOOD, MaterialColor.BROWN).sound(SoundType.WOOD).hardnessAndResistance(BlockHardnessValues.MAHOGANY.hardness, BlockHardnessValues.MAHOGANY.resistance)));
    ...
    public static final RegistryObject<Block> BAMBOO_FENCE = register("bamboo_fence", Builder.fence(Material.BAMBOO, MaterialColor.GREEN));
    public static final RegistryObject<Block> THATCH_FENCE = register("thatch_fence", Builder.fence(Material.PLANTS, MaterialColor.YELLOW));
    public static final RegistryObject<Block> CHUNK_FENCE = register("chunk_fence", Builder.fence(Material.ROCK, MaterialColor.BLACK));
    public static final RegistryObject<Block> PALM_FENCE = register("palm_fence", Builder.fence(Material.WOOD, MaterialColor.BROWN));
    public static final RegistryObject<Block> MAHOGANY_FENCE = register("mahogany_fence", Builder.fence(Material.WOOD, MaterialColor.BROWN));

    public static final RegistryObject<Block> BAMBOO_FENCE_GATE = register("bamboo_fence_gate", Builder.fenceGate(Material.BAMBOO, MaterialColor.GREEN));
    public static final RegistryObject<Block> THATCH_FENCE_GATE = register("thatch_fence_gate", Builder.fenceGate(Material.PLANTS, MaterialColor.YELLOW));
    public static final RegistryObject<Block> CHUNK_FENCE_GATE = register("chunk_fence_gate", Builder.fenceGate(Material.ROCK, MaterialColor.BLACK));
    public static final RegistryObject<Block> PALM_FENCE_GATE = register("palm_fence_gate", Builder.fenceGate(Material.WOOD, MaterialColor.BROWN));
    public static final RegistryObject<Block> MAHOGANY_FENCE_GATE = register("mahogany_fence_gate", Builder.fenceGate(Material.WOOD, MaterialColor.BROWN));
    ...
    private static <T extends Block> RegistryObject<T> register(String name, Supplier<T> sup, Supplier<Callable<ItemStackTileEntityRenderer>> renderMethod) {
        return register(name, sup, block -> item(block, renderMethod));
    }
    
    private static <T extends Block> RegistryObject<T> register(String name, Supplier<T> sup, ItemGroup tab) {
