...
public class TropicraftTileEntityTypes {
    ...
    public static final RegistryObject<TileEntityType<AirCompressorTileEntity>> AIR_COMPRESSOR = TILE_ENTITIES.register(
            "air_compressor", () -> new TileEntityType<>(AirCompressorTileEntity::new, Sets.newHashSet(TropicraftBlocks.AIR_COMPRESSOR.get()), null));
