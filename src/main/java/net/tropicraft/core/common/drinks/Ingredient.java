...
public class Ingredient implements Comparable<Ingredient> {
	...
	public static final Ingredient lemon = new Ingredient(5, new ItemStack(TropicraftItems.LEMON), true, 0xffff00).addAction(new DrinkActionFood(2, 0.2f));
	public static final Ingredient lime = new Ingredient(6, new ItemStack(TropicraftItems.LIME), true, 0x7fff00).addAction(new DrinkActionFood(2, 0.2f));
	public static final Ingredient orange = new Ingredient(7, new ItemStack(TropicraftItems.ORANGE), true, 0xffa500).addAction(new DrinkActionFood(3, 0.2f));
	public static final Ingredient grapefruit = new Ingredient(8, new ItemStack(TropicraftItems.GRAPEFRUIT), true, 0xff6347).addAction(new DrinkActionFood(4, 0.2f));
	public static final Ingredient pineapple = new Ingredient(9, new ItemStack(TropicraftBlocks.PINEAPPLE), false, 0xeeff00).addAction(new DrinkActionFood(1, 0.1f));
	public static final Ingredient pineappleCubes = new Ingredient(10, new ItemStack(TropicraftItems.PINEAPPLE_CUBES), false, 0xeeff00, 0.1f).addAction(new DrinkActionFood(1, 0.1f));
	public static final Ingredient coconut = new Ingredient(11, new ItemStack(TropicraftBlocks.COCONUT), false, 0xefefef).addAction(new DrinkActionFood(1, 0.1f));
	public static final Ingredient coconutChunk = new Ingredient(12, new ItemStack(TropicraftItems.COCONUT_CHUNK), false, 0xefefef/*, 0.1f*/).addAction(new DrinkActionFood(1, 0.1f));
	public static final Ingredient sugarcane = new Ingredient(13, new ItemStack(Items.SUGAR_CANE), false, 0xb1ff6b, 0.1f);
	public static final Ingredient roastedCoffeeBean = new Ingredient(14, new ItemStack(TropicraftItems.ROASTED_COFFEE_BEAN), false, 0x68442c, 0.95f).addAction(new DrinkActionFood(4, 0.2f)).addAction(new DrinkActionPotion(Effects.SPEED, 5, 1));
