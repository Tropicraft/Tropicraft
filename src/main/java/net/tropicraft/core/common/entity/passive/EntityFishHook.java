...
public class EntityFishHook extends Entity
{
    ...
    @SideOnly(Side.CLIENT)
    public EntityFishHook(World worldIn, double x, double y, double z, EntityKoaBase anglerIn)
    {
        this(worldIn);
    ...
    public EntityFishHook(World worldIn, EntityKoaBase fishingPlayer)
    {
        super(worldIn);
        this.pos = new BlockPos(-1, -1, -1);
        this.ignoreFrustumCheck = true;
