...
public class TropicraftPoiTypes extends PoiType {
    ...
    public static final RegistryObject<PoiType> TROPICRAFT_PORTAL = registerPoi("tropic_portal", ImmutableSet.of(), 0, 1);
    ...
    private static RegistryObject<PoiType> registerPoi(String pKey, Set<BlockState> p_27363_, int pMaxFreeTickets, int pValidRange) {
        return POI_TYPE.register(pKey, () -> new TropicraftPoiTypes(pKey, p_27363_, pMaxFreeTickets, pValidRange));
    }
