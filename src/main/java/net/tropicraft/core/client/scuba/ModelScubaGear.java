...
public class ModelScubaGear extends HumanoidModel<LivingEntity> {
    ...
    //public static final ModelScubaGear CHEST = new ModelScubaGear(0, EquipmentSlot.CHEST);
   // public static final ModelScubaGear FEET = new ModelScubaGear(0, EquipmentSlot.FEET);
   // public static final ModelScubaGear HEAD = new ModelScubaGear(0, EquipmentSlot.HEAD);
    ...
    public ModelScubaGear(final ModelPart root) {
        super(root);
    //    this( 0.0f, null );
    }
//
//    public ModelScubaGear(final float scale, final EquipmentSlot slot) {
