...
public class TropicraftLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(TropicraftLangKeys.ISLAND_ROYALE_FINISH, "Through the rising sea levels, the volatile and chaotic weather, and the struggle to survive, one player remains. The lone survivor of the island, %s, has won - but at what cost? The world is not what it once was, and they must survive in this new apocalyptic land.");
        add(TropicraftLangKeys.MINIGAME_FINISH, "The minigame will end in 10 seconds...");
        add(TropicraftLangKeys.ISLAND_ROYALE_START, "The year...2050. human caused climate change has gone unmitigated and the human population was forced to flee to higher ground." +
                ...
                "LET'S SEE!!!");
        add(TropicraftLangKeys.ISLAND_ROYALE_PVP_DISABLED, "NOTE: PvP is disabled for %s minutes! Go fetch resources before time runs out.");
        add(TropicraftLangKeys.ISLAND_ROYALE_PVP_ENABLED, "WARNING: PVP HAS BEEN ENABLED! Beware of other players...");
    }
