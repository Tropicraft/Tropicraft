...
public class TropicraftRenderLayers {
    ...
    public static ModelLayerLocation TROPI_BEE_BABY_LAYER;
    public static ModelLayerLocation COWKTAIL_LAYER;
    public static ModelLayerLocation COWKTAIL_BABY_LAYER;
    ...
    public static void registerLayers(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        TROPI_BEE_BABY_LAYER = registerMain("tropi_bee_baby", () -> TropiBeeModel.createBodyLayer().apply(TropiBeeModel.BABY_TRANSFORMER), event);
        COWKTAIL_LAYER = registerMain("cowktail", CowModel::createBodyLayer, event);
        COWKTAIL_BABY_LAYER = registerMain("cowktail_baby", () -> CowModel.createBodyLayer().apply(CowModel.BABY_TRANSFORMER), event);
