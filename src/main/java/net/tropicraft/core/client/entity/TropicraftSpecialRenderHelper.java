...
public class TropicraftSpecialRenderHelper {
    ...
    private static void vertex(IVertexBuilder bufferIn, Matrix4f matrixIn, Matrix3f matrixNormalIn, double x, double y, double z, float red, float green, float blue, float alpha, float texU, float texV, Direction normal, int packedLight, int packedOverlay) {
    ...
    private void popper(float f, float f1, float f2, float f3, float f1shifted, float f3shifted, MatrixStack stack, IVertexBuilder buffer, int packedLightIn, int overlayLightIn) {
        ...
        vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), 0.0D, 1.0D, 0.0F - f5, red, green, blue, alpha, f, f1, Direction.NORTH, packedLightIn, overlayLightIn);
        vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), f4, 1.0D, 0.0F - f5, red, green, blue, alpha, f2, f1, Direction.NORTH, packedLightIn, overlayLightIn);
        vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), f4, 0.0D, 0.0F - f5, red, green, blue, alpha, f2, f3, Direction.NORTH, packedLightIn, overlayLightIn);
        vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), 0.0D, 0.0D, 0.0F - f5, red, green, blue, alpha, f, f3, Direction.NORTH, packedLightIn, overlayLightIn);

        for (int i = 0; i < 32; i++) {
            float f6 = (float) i / 32F;
            float f10 = (f + (f2 - f) * f6) - 0.001953125F;
            float f14 = f4 * f6;
            vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), f14, 0.0D, 0.0F - f5, red, green, blue, alpha, f10, f3, Direction.EAST, packedLightIn, overlayLightIn);
            ...
            vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), f14, 1.0D, 0.0F - f5, red, green, blue, alpha, f10, f1, Direction.EAST, packedLightIn, overlayLightIn);
        }
        ...
        for (int j = 0; j < 32; j++) {
            ...
            vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), f15, 1.0D, 0.0F - f5, red, green, blue, alpha, f11, f1, Direction.WEST, packedLightIn, overlayLightIn);
            ...
            vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), f15, 0.0D, 0.0F - f5, red, green, blue, alpha, f11, f3, Direction.WEST, packedLightIn, overlayLightIn);
        }
        ...
        for (int k = 0; k < 32; k++) {
            ...
            vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), f4, f16, 0.0F - f5, red, green, blue, alpha, f2, f12, Direction.UP, packedLightIn, overlayLightIn);
            vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), 0.0D, f16, 0.0F - f5, red, green, blue, alpha, f, f12, Direction.UP, packedLightIn, overlayLightIn);
        }
        ...
        for (int l = 0; l < 32; l++) {
            ...
            vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), 0.0D, f17, 0.0F - f5, red, green, blue, alpha, f, f13, Direction.DOWN, packedLightIn, overlayLightIn);
            vertex(buffer, stack.getLast().getMatrix(), stack.getLast().getNormal(), f4, f17, 0.0F - f5, red, green, blue, alpha, f2, f13, Direction.DOWN, packedLightIn, overlayLightIn);
        }
    }
}
