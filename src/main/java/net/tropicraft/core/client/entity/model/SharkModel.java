...
public class SharkModel extends SegmentedModel<SharkEntity> {
    ...
    @Override
    public void setRotationAngles(SharkEntity shark, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        FinPectoralLeft.rotateAngleZ = (0.4f -(float) Math.sin(ageInTicks * timeScale)*0.3f);
        FinPectoralRight.rotateAngleZ = (-0.4f -(float) Math.sin(ageInTicks * timeScale)*0.3f);

        Body3UpperLeft.rotateAngleY =  -(float) Math.sin(ageInTicks * timeScale)*0.2f;
        Body3LowerLeft.rotateAngleY =  -(float) Math.sin(ageInTicks * timeScale)*0.2f;
        Body3LowerRight.rotateAngleY =  -(float) Math.sin(ageInTicks * timeScale)*0.2f;

        //FinCaudalUpper.offsetX = -(float) Math.sin(ageInTicks * timeScale)*0.175f;
        FinCaudalUpper.rotateAngleY =  -(float) Math.sin(ageInTicks * timeScale)*0.2f;

        //FinCaudalLower.offsetX = -(float) Math.sin(ageInTicks * timeScale)*0.175f;
        FinCaudalLower.rotateAngleY =  -(float) Math.sin(ageInTicks * timeScale)*0.2f;

        //FinAdipose.offsetX = -(float) Math.sin(ageInTicks * timeScale)*0.025f;
        FinAdipose.rotateAngleY =  -(float) Math.sin(ageInTicks * timeScale)*0.2f;

        //FinAnal.offsetX = -(float) Math.sin(ageInTicks * timeScale)*0.025f;
        FinAnal.rotateAngleY =  -(float) Math.sin(ageInTicks * timeScale)*0.2f;
    }
