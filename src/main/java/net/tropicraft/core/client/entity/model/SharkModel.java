...
public class SharkModel extends EntityModel<SharkEntity> {
    ...
    public SharkModel() {
        ...
        Head1 = new RendererModel(this, 0, 24);
        ...
        Head3 = new RendererModel(this, 0, 46);
        ...
        Body1Upper = new RendererModel(this, 18, 0);
        ...
        Body1Lower = new RendererModel(this, 28, 47);
        ...
        Body2Upper = new RendererModel(this, 40, 0);
        ...
        Body2Lower = new RendererModel(this, 52, 39);
        ...
        Body3UpperLeft = new RendererModel(this, 60, 0);
        ...
        Body3LowerLeft = new RendererModel(this, 74, 45);
        ...
        Body3LowerRight = new RendererModel(this, 74, 45);
        ...
        FinPectoralLeft = new RendererModel(this, 88, 57);
        ...
        FinPectoralRight = new RendererModel(this, 88, 57);
        ...
        FinDorsal = new RendererModel(this, 94, -7);
        ...
        FinPelvicLeft = new RendererModel(this, 96, 52);
        ...
        FinPelvicRight = new RendererModel(this, 96, 52);
        ...
        FinAdipose = new RendererModel(this, 109, -3);
        ...
        FinAnal = new RendererModel(this, 108, 47);
        ...
        FinCaudalUpper = new RendererModel(this, 116, -6);
        ...
        FinCaudalLower = new RendererModel(this, 116, 46);
        ...
        Body3Lower = new RendererModel(this, 14, 48);
        ...
        Body4Lower = new RendererModel(this, 14, 48);
    ...
    @Override
    public void render(SharkEntity entity, float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    @Override
    public void setRotationAngles(final SharkEntity e, float f, float f1, float f2, float f3, float f4, float f5) {
