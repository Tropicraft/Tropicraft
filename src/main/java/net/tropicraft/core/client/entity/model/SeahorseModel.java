...
public class SeahorseModel extends EntityModel<LivingEntityRenderState> {
    ...
    public static LayerDefinition create() {
        ...
        root.addOrReplaceChild("head1",
                ...
                PartPose.offsetAndRotation(1.0f, -20.0f, 0.5f, 0.0f, 0.0f, -0.7060349f));

        root.addOrReplaceChild("snout1",
                CubeListBuilder.create().texOffs(20, 0)
                        .addBox(-1.5f, -1.0f, -1.5f, 3, 3, 4),
                PartPose.offsetAndRotation(-2.448189f, -17.97269f, 2.980232E-08F, 0.0f, 0.0f, -0.7060349f));

        root.addOrReplaceChild("snout2",
                CubeListBuilder.create().texOffs(34, 0)
                        .addBox(-2.5f, -0.5f, -0.5f, 5, 2, 2),
                PartPose.offsetAndRotation(-5.491952f, -15.377399f, 2.980232E-08F, 0.0f, 0.0f, -0.7060349f));

        root.addOrReplaceChild("snout3",
                CubeListBuilder.create().texOffs(23, 7)
                        .addBox(-0.5f, -1.0f, -1.0f, 1, 3, 3),
                PartPose.offsetAndRotation(-7.54649f, -13.62558f, 0.0f, 0.0f, 0.0f, -1.055101f));

        root.addOrReplaceChild("eye1",
                CubeListBuilder.create().texOffs(40, 4)
                        .addBox(-1.0f, -1.0f, -0.5f, 2, 2, 1),
                PartPose.offsetAndRotation(-2.955017f, -18.834728f, -2.0f, -0.1802033f, 0.1073159f, -0.7155942f));

        root.addOrReplaceChild("eye2",
                CubeListBuilder.create().texOffs(40, 4)
                        .addBox(-1.0f, -1.0f, -0.5f, 2, 2, 1),
                PartPose.offsetAndRotation(-2.958766f, -18.832321f, 3.0f, -0.1327665f, 2.978997f, -2.432569f));

        root.addOrReplaceChild("fin2",
                CubeListBuilder.create().texOffs(39, 15)
                        .addBox(-3.0f, -2.5f, 0.0f, 6, 5, 0),
                PartPose.offsetAndRotation(1.222835f, -22.818329f, 0.5f, 0.0f, 0.0f, -0.1043443f));

        root.addOrReplaceChild("fin4",
                CubeListBuilder.create().texOffs(36, 9)
                        .addBox(-4.0f, -2.5f, 0.0f, 4, 5, 0),
                PartPose.offsetAndRotation(1.000001f, -20.0f, -2.0f, -0.2562083f, -2.679784f, 0.4709548f));

        root.addOrReplaceChild("fin3",
                CubeListBuilder.create().texOffs(45, 9)
                        .addBox(-4.0f, -2.5f, 0.0f, 4, 5, 0),
                PartPose.offsetAndRotation(1.000001f, -20.0f, 3.0f, 0.2562083f, 2.679784f, 0.4709548f));

        root.addOrReplaceChild("neck1",
                CubeListBuilder.create().texOffs(0, 10)
                        .addBox(-2.0f, -2.0f, -2.0f, 4, 4, 4),
                PartPose.offsetAndRotation(3.5f, -17.5f, 0.5f, 0.0f, 0.0f, -0.7853982f));

        root.addOrReplaceChild("neck2",
                CubeListBuilder.create().texOffs(0, 18)
                        .addBox(-2.5f, -2.0f, -2.5f, 5, 4, 5),
                PartPose.offsetAndRotation(4.999997f, -15.0f, 0.5f, 0.0f, 0.0f, -0.349066f));

        root.addOrReplaceChild("belly",
                CubeListBuilder.create().texOffs(0, 27)
                        .addBox(-3.5f, 0.0f, -3.0f, 7, 8, 6),
                PartPose.offset(5.0f, -14.0f, 0.5f));

        root.addOrReplaceChild("tail1",
                CubeListBuilder.create().texOffs(0, 18)
                        .addBox(-2.5f, 0.0f, -2.5f, 5, 4, 5),
                PartPose.offsetAndRotation(5.5f, -6.5f, 0.5f, 0.0f, 0.0f, 0.08726645f));

        root.addOrReplaceChild("tail2",
                CubeListBuilder.create().texOffs(0, 41)
                        .addBox(-2.0f, 0.0f, -2.0f, 4, 4, 4),
                PartPose.offsetAndRotation(5.0f, -3.0f, 0.5f, 0.0f, 0.0f, 0.3490658f));

        root.addOrReplaceChild("tail3",
                CubeListBuilder.create().texOffs(0, 49)
                        .addBox(-2.0f, 0.0f, -1.5f, 3, 4, 3),
                PartPose.offsetAndRotation(4.5f, 0.5f, 0.5f, 0.0f, 0.0f, 0.6981316f));

        root.addOrReplaceChild("tail4",
                CubeListBuilder.create().texOffs(0, 56)
                        .addBox(-1.0f, 0.0f, -1.0f, 2, 4, 2),
                PartPose.offsetAndRotation(2.652397f, 3.1008196f, 0.5f, 0.0f, 0.0f, 1.466756f));

        root.addOrReplaceChild("tail5",
                CubeListBuilder.create().texOffs(8, 56)
                        .addBox(-0.5f, 0.0f, -0.5f, 1, 2, 1),
                PartPose.offsetAndRotation(-0.8942064f, 3.48069f, 0.5f, 0.0f, 0.0f, 1.947916f));

        root.addOrReplaceChild("tail6",
                CubeListBuilder.create().texOffs(12, 56)
                        .addBox(-0.5f, 0.0f, -0.5f, 1, 2, 1),
                PartPose.offsetAndRotation(-2.551666f, 2.9303904f, 0.5f, 0.0f, 0.0f, 2.471515f));

        root.addOrReplaceChild("tail7",
                CubeListBuilder.create().texOffs(12, 56)
                        .addBox(-0.5f, 0.0f, -0.5f, 1, 2, 1),
                PartPose.offsetAndRotation(-3.685031f, 1.52843f, 0.5f, 0.0f, 0.0f, -3.113539f));

        root.addOrReplaceChild("tail8",
                CubeListBuilder.create().texOffs(12, 56)
                        .addBox(-0.5f, 0.0f, -0.5f, 1, 2, 1),
                PartPose.offsetAndRotation(-3.770199f, -0.050409317f, 0.5f, 0.0f, 0.0f, -2.415407f));

        root.addOrReplaceChild("tail9",
                CubeListBuilder.create().texOffs(12, 56)
                        .addBox(-0.5f, 0.0f, -0.5f, 1, 2, 1),
                PartPose.offsetAndRotation(-2.846481f, -1.3606491f, 0.5f, 0.0f, 0.0f, -1.542743f));

        root.addOrReplaceChild("tail10",
                CubeListBuilder.create().texOffs(12, 56)
                        .addBox(-0.5f, 0.0f, -0.5f, 1, 2, 1),
                PartPose.offsetAndRotation(-0.2576861f, 0.2257204f, 0.5f, 0.0f, 0.0f, 2.659437f));

        root.addOrReplaceChild("tail11",
                CubeListBuilder.create().texOffs(12, 56)
                        .addBox(-0.5f, -1.0f, -0.5f, 1, 2, 1),
                PartPose.offsetAndRotation(-0.856306f, 0.52847004f, 0.5f, 0.0f, 0.0f, -2.415407f));

        root.addOrReplaceChild("fin1",
                CubeListBuilder.create().texOffs(40, 22)
                        .addBox(-2.5f, -4.0f, 0.0f, 5, 8, 0),
                PartPose.offsetAndRotation(8.5f, -4.0f, 0.5f, 0.0f, 0.0f, 0.2188137f));

        return LayerDefinition.create(mesh, 64, 64).apply(MeshTransformer.scaling(0.5f));
    }

    @Override
    public void setupAnim(LivingEntityRenderState state) {
        super.setupAnim(state);
        fin2.zRot = Mth.cos(state.walkAnimationPos * 0.6662f) * 1.4f * state.walkAnimationSpeed;
    }
}
