...
public class SeahorseModel extends SegmentedModel<SeahorseEntity> {
    ModelRenderer head1;
    ...
    @Override
    public void setLivingAnimations(SeahorseEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
    ...
    public void setRotationAngles(SeahorseEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        fin2.rotateAngleZ = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount;
    }
