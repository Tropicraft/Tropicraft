...
public class VMonkeyModel extends EntityModel<VMonkeyRenderState> implements ArmedModel {
    ...
    @Override
    public void setupAnim(VMonkeyRenderState state) {
        super.setupAnim(state);

        face.yRot = state.yRot * Mth.DEG_TO_RAD + Mth.PI;
        face.xRot = state.xRot * Mth.DEG_TO_RAD;

        if (state.isOrderedToSit) {
            ...
            rLegUpper.xRot = Mth.cos(state.walkAnimationPos * 0.5f) * 0.75f * state.walkAnimationSpeed - Mth.HALF_PI;
            rArmUpper.xRot = Mth.cos(state.walkAnimationPos * 0.5f) * 0.75f * state.walkAnimationSpeed - Mth.HALF_PI;
            lArmUpper.xRot = Mth.cos(state.walkAnimationPos * 0.5f) * 0.75f * state.walkAnimationSpeed - Mth.HALF_PI;
            lLegUpper.xRot = Mth.cos(state.walkAnimationPos * 0.5f) * 0.75f * state.walkAnimationSpeed - Mth.HALF_PI;
            ...
            rLegUpper.xRot = Mth.cos(state.walkAnimationPos * 0.6662f) * 0.75f * state.walkAnimationSpeed;
            rArmUpper.xRot = Mth.cos(state.walkAnimationPos * 0.6662f + Mth.PI) * 0.75f * state.walkAnimationSpeed;
            lLegUpper.xRot = Mth.cos(state.walkAnimationPos * 0.6662f + Mth.PI) * 0.75f * state.walkAnimationSpeed;
            lArmUpper.xRot = Mth.cos(state.walkAnimationPos * 0.6662f) * 0.75f * state.walkAnimationSpeed;
            ...
            tailBase.xRot = Mth.cos(state.walkAnimationPos * 0.6662f) * 0.50f * state.walkAnimationSpeed;
            tailBase.zRot = Mth.cos(state.walkAnimationPos * 0.6662f) * 0.50f * state.walkAnimationSpeed;
            ...
            tailMid.xRot = tailBase.xRot + Mth.cos(state.walkAnimationPos * 0.6662f) * 0.75f * state.walkAnimationSpeed;
            tailMid.zRot = tailBase.zRot + Mth.cos(state.walkAnimationPos * 0.6662f) * 0.75f * state.walkAnimationSpeed;
            ...
            tailTop.xRot = tailMid.xRot + Mth.cos(state.walkAnimationPos * 0.6662f) * 1.75f * state.walkAnimationSpeed;
            tailTop.zRot = tailMid.xRot + Mth.cos(state.walkAnimationPos * 0.6662f) * 1.75f * state.walkAnimationSpeed;
        }
