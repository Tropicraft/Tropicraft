...
public class DrinkMixerSpecialRenderer extends MachineSpecialRenderer {
    public DrinkMixerSpecialRenderer(EIHMachineModel model, Material material) {
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked {
        ...
        public SpecialModelRenderer<?> bake(EntityModelSet modelSet) {
            EIHMachineModel model = new EIHMachineModel(modelSet.bakeLayer(TropicraftRenderLayers.EIHMACHINE_LAYER));
            return new DrinkMixerSpecialRenderer(model, DrinkMixerBlockEntityRenderer.MATERIAL);
        }
    }
}
